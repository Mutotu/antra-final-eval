...
const searchArtist = (artist)=>{
    const data = _axiosDefault.default.get(`https://itunes.apple.com/search?term=${artist}&media=music&entity=album&attribute=artistTerm&limit=200`);
    data.then((res)=>{
...
searchButton.addEventListener("click", ()=>{
    ...
    if (checkInput(search.value)) {
        ...
        search.value = null;
    } else error.innerHTML = "Please enter valid entry";
});
...
},{"process":"lgxVX","../utils":"5By4s","../helpers/normalizeHeaderName":"adBZo","../core/enhanceError":"itUQr","./transitional":"lM32f","../adapters/xhr":"ldm57","../adapters/http":"ldm57"}],"lgxVX":[function(require,module,exports) {
...
},{}]},["iKiqL","bB7Pu"], "bB7Pu", "parcelRequire57b6")
